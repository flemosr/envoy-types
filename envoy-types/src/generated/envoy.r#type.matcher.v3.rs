...
impl ::prost::Name for HttpResponseLocalReplyMatchInput {
    const NAME: &'static str = "HttpResponseLocalReplyMatchInput";
    const PACKAGE: &'static str = "envoy.type.matcher.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.type.matcher.v3.HttpResponseLocalReplyMatchInput".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.type.matcher.v3.HttpResponseLocalReplyMatchInput"
            .into()
    }
}

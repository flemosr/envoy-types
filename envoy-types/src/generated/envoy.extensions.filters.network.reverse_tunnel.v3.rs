...
pub struct DrainAwareHttpConnectionManager {
    ...
    pub hcm_config: ::core::option::Option<
        super::super::http_connection_manager::v3::HttpConnectionManager,
    >,
...
impl ::prost::Name for DrainAwareHttpConnectionManager {
    const NAME: &'static str = "DrainAwareHttpConnectionManager";
    ...
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.extensions.filters.network.reverse_tunnel.v3.DrainAwareHttpConnectionManager"
            .into()
    }
}
...
pub struct ReverseTunnel {
    ...
    /// `envoy.filters.network.reverse_tunnel.jwt`) so the :ref:`Validation  <envoy_v3_api_msg_extensions.filters.network.reverse_tunnel.v3.Validation>` block can bind a
    ...
    ///
    /// See :ref:`JwtHandshakeValidator  <envoy_v3_api_msg_extensions.filters.common.jwks.v3.JwtHandshakeValidator>`.
    #[prost(message, optional, tag = "10")]
    pub jwt_validator: ::core::option::Option<
        super::super::super::common::jwks::v3::JwtHandshakeValidator,
    >,

...
impl ::prost::Name for FileSystemHttpCacheV2Config {
    const NAME: &'static str = "FileSystemHttpCacheV2Config";
    const PACKAGE: &'static str = "envoy.extensions.http.cache_v2.file_system_http_cache.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.extensions.http.cache_v2.file_system_http_cache.v3.FileSystemHttpCacheV2Config"
            .into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.extensions.http.cache_v2.file_system_http_cache.v3.FileSystemHttpCacheV2Config"
            .into()
    }
}

...
///
///
/// For a load report to update an endpoint's weight, it must set :ref:`rps_fractional  <envoy_v3_api_field_.xds.data.orca.v3.OrcaLoadReport.rps_fractional>` (used as
...
/// : ref:`metric_names_for_computing_utilization  <envoy_v3_api_field_extensions.load_balancing_policies.client_side_weighted_round_robin.v3.ClientSideWeightedRoundRobin.metric_names_for_computing_utilization>`)
...
pub struct ClientSideWeightedRoundRobin {
    ...
    pub oob_reporting_config: ::core::option::Option<
        super::super::common::v3::OrcaOobReportingConfig,
    >,
}

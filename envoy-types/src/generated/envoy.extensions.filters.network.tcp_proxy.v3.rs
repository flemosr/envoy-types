...
pub struct TcpProxy {
    ...
    pub max_downstream_connection_duration_jitter_percentage: ::core::option::Option<
    ...
    pub proxy_protocol_tlvs: ::prost::alloc::vec::Vec<
        super::super::super::super::super::config::core::v3::TlvEntry,
    >,
    ///
    ...
    pub max_early_data_bytes: ::core::option::Option<
        super::super::super::super::super::super::google::protobuf::UInt32Value,
    >,
    ...
    pub check_drain_close: ::core::option::Option<
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD" => {
                Some(Self::OverwriteByTypeIfExistsOrAdd)
            }

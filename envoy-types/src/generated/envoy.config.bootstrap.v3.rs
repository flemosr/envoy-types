...
pub struct Bootstrap {
    ...
    /// Defaults to `false`.
    #[prost(bool, tag = "43")]
    pub enable_worker_cpu_affinity: bool,
...
pub struct MemoryAllocatorManager {
    ...
    #[prost(message, optional, tag = "3")]
    pub soft_memory_limit_bytes: ::core::option::Option<
        super::super::super::super::google::protobuf::UInt64Value,
    >,
    ...
    /// This is currently only supported with tcmalloc and not with `gperftools`.
    #[prost(message, optional, tag = "4")]
    pub max_per_cpu_cache_size_bytes: ::core::option::Option<
...
impl ::prost::Name for ListenerManager {
    ...
    const PACKAGE: &'static str = "envoy.config.bootstrap.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.config.bootstrap.v3.ListenerManager".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.config.bootstrap.v3.ListenerManager".into()
    }
}
/// A placeholder proto so that users can explicitly configure the standard
...
impl ::prost::Name for ValidationListenerManager {
    ...
    const PACKAGE: &'static str = "envoy.config.bootstrap.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.config.bootstrap.v3.ValidationListenerManager".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.config.bootstrap.v3.ValidationListenerManager".into()
    }
}
...
pub struct ApiListenerManager {
    ...
    #[prost(enumeration = "api_listener_manager::ThreadingModel", tag = "1")]
    pub threading_model: i32,
}
/// Nested message and enum types in `ApiListenerManager`.
pub mod api_listener_manager {
    #[derive(
        Clone,
        Copy,
        Debug,
    ...
    impl ThreadingModel {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::MainThreadOnly => "MAIN_THREAD_ONLY",
                Self::StandaloneWorkerThread => "STANDALONE_WORKER_THREAD",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "MAIN_THREAD_ONLY" => Some(Self::MainThreadOnly),
                "STANDALONE_WORKER_THREAD" => Some(Self::StandaloneWorkerThread),
                _ => None,
            }
        }
    }
...
impl ::prost::Name for ApiListenerManager {
    ...
    const PACKAGE: &'static str = "envoy.config.bootstrap.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.config.bootstrap.v3.ApiListenerManager".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.config.bootstrap.v3.ApiListenerManager".into()
    }
}

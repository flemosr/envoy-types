...
/// Extension to build custom attributes in the :ref:`request  <envoy_v3_api_msg_service.ext_proc.v3.ProcessingRequest>` based on a configurable mapping. The
...
///
/// If this extension is configured, then the original :ref:`ProcessingRequest  <envoy_v3_api_msg_service.ext_proc.v3.ProcessingRequest>`'s `request_attributes` are ignored,
...
pub struct MappedAttributeBuilder {
    ...
    pub mapped_request_attributes: ::std::collections::HashMap<
...
impl ::prost::Name for MappedAttributeBuilder {
    ...
    const PACKAGE: &'static str = "envoy.extensions.http.ext_proc.processing_request_modifiers.mapped_attribute_builder.v3";
    ...
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.extensions.http.ext_proc.processing_request_modifiers.mapped_attribute_builder.v3.MappedAttributeBuilder"
            .into()
    }
}

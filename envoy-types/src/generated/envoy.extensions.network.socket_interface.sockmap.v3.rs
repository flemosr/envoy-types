...
pub struct Sockmap {
    ...
    /// datapath.
    #[prost(string, tag = "1")]
    pub bpf_program_path: ::prost::alloc::string::String,
    ...
    pub sockhash_max_entries: ::core::option::Option<
    ...
    pub register_user_space_sockets: ::core::option::Option<
    ...
    pub accelerated_ports: ::prost::alloc::vec::Vec<
        super::super::super::super::super::r#type::v3::Int64Range,
    >,
}
impl ::prost::Name for Sockmap {
    const NAME: &'static str = "Sockmap";
    const PACKAGE: &'static str = "envoy.extensions.network.socket_interface.sockmap.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.extensions.network.socket_interface.sockmap.v3.Sockmap".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.extensions.network.socket_interface.sockmap.v3.Sockmap"
            .into()
    }
}

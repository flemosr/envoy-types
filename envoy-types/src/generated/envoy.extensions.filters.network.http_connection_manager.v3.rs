...
pub struct HttpConnectionManager {
    ...
    /// : ref:`max_connection_duration_jitter  <envoy_v3_api_field_config.core.v3.HttpProtocolOptions.max_connection_duration_jitter>`,
    ///   but applied to the drain grace timer rather than the connection duration timer.
    #[prost(message, optional, tag = "62")]
    pub drain_timeout_jitter: ::core::option::Option<

...
pub struct TraceWrapper {
    ...
    /// : ref:`default_value  <envoy_v3_api_field_config.core.v3.RuntimeFractionalPercent.default_value>` of
    ...
    /// .. note::
    ///
    /// When :ref:`runtime_key    <envoy_v3_api_field_config.core.v3.RuntimeFractionalPercent.runtime_key>` is
    ...
    #[prost(message, optional, tag = "5")]
    pub configured_sample_rate: ::core::option::Option<

...
pub struct IpTagging {
    ...
    pub ip_tags_datasource: ::core::option::Option<
...
pub mod ip_tagging {
    ...
    pub struct IpTags {
        ...
        pub ip_tags: ::prost::alloc::vec::Vec<IpTag>,
    }
    impl ::prost::Name for IpTags {
        const NAME: &'static str = "IPTags";
        const PACKAGE: &'static str = "envoy.extensions.filters.http.ip_tagging.v3";
        fn full_name() -> ::prost::alloc::string::String {
            "envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTags".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTags"
                .into()
        }
    }
    /// Specify to which header the tags will be written.

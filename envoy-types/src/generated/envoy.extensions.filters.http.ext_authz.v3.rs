...
pub struct ShadowDecision {
    ...
    pub response_headers: ::prost::alloc::vec::Vec<
...
impl ::prost::Name for ShadowDecision {
    const NAME: &'static str = "ShadowDecision";
    const PACKAGE: &'static str = "envoy.extensions.filters.http.ext_authz.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.extensions.filters.http.ext_authz.v3.ShadowDecision".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.extensions.filters.http.ext_authz.v3.ShadowDecision"
            .into()
    }
}

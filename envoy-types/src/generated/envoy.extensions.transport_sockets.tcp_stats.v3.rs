...
impl ::prost::Name for Config {
    ...
    const PACKAGE: &'static str = "envoy.extensions.transport_sockets.tcp_stats.v3";
    fn full_name() -> ::prost::alloc::string::String {
        "envoy.extensions.transport_sockets.tcp_stats.v3.Config".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/envoy.extensions.transport_sockets.tcp_stats.v3.Config"
            .into()
    }
}
